...
```
Output of the test will be found at `checkpoints_dir/name/test_img_out` where `checkpoints_dir` and `name` are flags.  Post-processing not yet implemented in the current version.
...
If someone could find the issue in this implementation, please open an issue in this repo and if possible post your suggestion.
